...
export default function Initiatives() {
  return (
    ...
    <div className="Initiatives bg-gradient-to-b from-[#051923] via-[#3282B885] via-[#00538169] to-[#051923] py-20">
      <div className="md:flex items-center justify-center py-12 text-6xl px-12 wow animate__animated animate__fadeInUp">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 mx-14 md:mx-32 pb-16 gap-20 lg:mx-28 lg:gap-24 pt-12 wow animate__animated animate__fadeInUpBig">
      {data.map((item) => (
  <CardContainer
    key={item.id}
    title={item.title}
